...
class CreateManifestationComitesTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::connection('mysql')->create('manifestation_comites', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('comite_organisation_id')->references('id')->on('comite_organisations') ->onDelete('cascade');
    ...
    {
        Schema::connection('mysql')->dropIfExists('manifestation_comites');
    }
}
