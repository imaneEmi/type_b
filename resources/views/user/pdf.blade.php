...
<div id="content_wrapper">
        ...
        <div id="table_invoice_details">
            <table>
                ...
                <tr>
                    ...
                    <td class="td-2">
                        <br> {{$responsableEntiteOrganisatrice->nom}} {{$responsableEntiteOrganisatrice->prenom}}</td>
    ...
    <div id="content">
        ...
        <div id="table_invoice_details">
            ...
            <div>
            @foreach($manifestationTypeContributeur as $item)
                      {{$item->typeContributeur->libelle}},
            @endforeach
            </div>
        </div>
    </div>
