                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" name="etablissements_organisateur[]"
                                                id="etablissements_organisateur" multiple="multiple" data-height="100%">
                                                @foreach ($etablissements as $etablissement)
                                                <option value="{{$etablissement->id}}" id="{{$etablissement->libelle}}"
                                                    selected>{{$etablissement->libelle}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Numbre participants prevus </label>
                                            <input type="number" class="form-control" name="nbr_participants_prevus"
                                                min="0" required="">
                                        </div>
                                        <div class="form-group">
                                            <label>Date debut</label>
                        ...
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>nom</label>
                                        <input type="text" class="form-control" name="nom_entite_organisatrice"
                                            required="">
                                    </div>
                                    <div class="form-group">
                                        <label>responsable</label>
                                        <input type="text" class="form-control" name="responsable_entite_organisatrice"
                                            required="">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" name="etablissement_entite_organisatrice">
                                            @foreach ($etablissements as $etablissement)
                                            <option value="{{$etablissement->id}}" selected>{{$etablissement->libelle}}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id='libelle_gestion_financiere'
                                            name="libelle_gestion_financiere">
                                    </div>
                                    <div class="form-group">
                                        <label>Information</label>
                                        <input type="text" min="0" class="form-control"
                                            id='information_gestion_financiere' name="information_gestion_financiere">
                                    </div>
                                </div>
                                <div class="card-footer text-right">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$user->name}}" class="form-control"
                                            name="nom_coordonnateur_manifestation" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label>Prenom</label>
                                        <input type="text" value="{{$user->prenom}}" class="form-control"
                                            name="prenom_coordonnateur_manifestation" name="type" disabled>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Tel</label>
                                        <input type="tel" value="{{$user->tel}}" class="form-control"
                                            name="tel_coordonnateur_manifestation" name="type" required="">
                                    </div>
                                    <div class="form-group">
                                        <label>Fax</label>
                                        <input type="tel" class="form-control" name="fax_coordonnateur_manifestation"
                                            name="fax_coordonnateur_manifestation">
                                    </div>
                                </div>
                                <div class="card-footer text-right">
                        ...
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="type_contributeur" name="type_contributeur">
                                            ...
                                            <option value="{{$typeContributeur->id}}"
                                                id="{{$typeContributeur->libelle}}" selected>
                                                {{$typeContributeur->libelle}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Montant</label>
                                        <input type="number" min="0" class="form-control" id='montant_contributeur'
                                            name="montant_contributeur">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="nature_contributeur"
                                            ...
                                            <option value="{{$natureContribution->id}}"
                                                id="{{$natureContribution->libelle}}" selected>
                                                {{$natureContribution->libelle}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="card-footer text-right">
                                    <p style="cursor:pointer" class="btn btn-primary"
                                        onclick="addContributeur(document.getElementById('nom_contributeur').value,$('#type_contributeur').children(':selected').attr('id'),document.getElementById('type_contributeur').value ,document.getElementById('montant_contributeur').value,$('#nature_contributeur').children(':selected').attr('id'),document.getElementById('nature_contributeur').value );">
                                        +</p>
                                </div>
                                <div style="overflow-x:auto;">
                        ...
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Nom</label>
                                        <input type="text" class="form-control" id="nom_organisateur"
                                            name="nom_organisateur">
                                    </div>
                                    <div class="form-group">
                                        <label> Prenom</label>
                                        <input type="text" class="form-control" id="prenom_organisateur"
                                            name="prenom_organisateur">
                                    </div>
                                    <div class="form-group">
                                        <label> Tel</label>
                                        <input type="tel" class="form-control" id="tel_organisateur"
                                            name="tel_organisateur">
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="text" class="form-control" id="email_organisateur"
                                            name="email_organisateur">
                                    </div>
                                    <div class="section-title mt-0">Etablissment</div>
                                    <div class="form-group">
                                        <select class="custom-select" id="etablissement_organisateur"
                                            name="etablissement_organisateur">
                                            @foreach ($etablissements as $etablissement)
                                            <option value="{{$etablissement->id}}" id="{{$etablissement->libelle}}"
                                                selected>{{$etablissement->libelle}}</option>
                                            @endforeach
                                    ...
                                    <div class="card-footer text-right">
                                        <p style="cursor:pointer" class="btn btn-primary"
                                            onclick="addOrganisateur(document.getElementById('tel_organisateur').value,document.getElementById('nom_organisateur').value ,document.getElementById('prenom_organisateur').value,document.getElementById('email_organisateur').value, $('#etablissement_organisateur').children(':selected').attr('id') ,document.getElementById('etablissement_organisateur').value );">
                                            +</p>
                                    </div>
                                    <div style="overflow-x:auto;">
                                ...
                                <div class="card-body">
                                    <div id="accordion">
                                        ...
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-body collapse " id="panel-body-{{$fr->id}}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="0" class="form-control"
                                                        ...
                                                        name="nombre_frais_ouvert_{{$fr->id}}" required="" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label> Montant (DH)</label>
                                                    <input type="number" min="0" class="form-control"
                                                        id='montant_frais_ouvert_{{$fr->id}}'
                                                        name="montant_frais_ouvert_{{$fr->id}}" required="" disabled>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        name="remarques_frais_ouvert_{{$fr->id}}" required="" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
