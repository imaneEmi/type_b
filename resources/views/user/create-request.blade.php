                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label> Intitulé de la manifestation <label style="color: red ">*</label> </label>
                                            <input type="text" class="form-control" name="intitule" required="">
                                        </div>
                                        <div class="form-group">
                                            <label>Type(Workshop...) <label style="color: red ">*</label></label>
                                        ...
                                        <div class="form-group">
                                            <label>Etendue(Locale,Régionale...) <label style="color: red ">*</label></label>
                                        ...
                                        <div class="form-group">
                                            <label> Partenaire(s) impliqué(s) <label style="color: red ">*</label> </label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    <label>Nombre etudiants locaux <label style="color: red ">*</label> </label>
                                                    <input type="number" class="form-control" name="nbr_etudiants_locaux" min="0" required="">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-lg-6">
                                                <label>Liste des etudiants locaux <label style="color: red ">*</label></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <label>Liste des enseignants locaux <label style="color: red ">*</label></label>
                                                <div class="custom-file">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    <label>Nombre enseignants non locaux <label style="color: red ">*</label> </label>
                                                    <input type="number" class="form-control" name="nbr_enseignants_non_locaux" min="0" required="">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    <label>Nombre etudiants non locaux <label style="color: red ">*</label></label>
                    ...
                    <div class="page">
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Libelle(Agence,Association scientifique...) <label style="color: red ">*</label></label>
                                ...
                                <div class="card-footer text-right">
                                    <p style="cursor:pointer" class="btn btn-primary" onclick="addGestionFinanciere(document.getElementById('libelle_gestion_financiere').value,document.getElementById('information_gestion_financiere').value );">
                                        +</p>
                                </div>
                        ...
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select" id="typeContributeurs_s">
                                            @foreach ($typeContributeurs as $item)
                                            <option value="{{$item->id}}" id="{{$item->libelle}}" selected>{{$item->libelle}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="card-footer text-right">
                                    <p style="cursor:pointer" class="btn btn-primary" onclick="addContributeur(document.getElementById('nom_contributeur').value,document.getElementById('montant_contributeur').value,$('#nature_contributeur').children(':selected').attr('id'),document.getElementById('nature_contributeur').value,$('#typeContributeurs_s').children(':selected').attr('id'),document.getElementById('typeContributeurs_s').value );">
                                        +</p>
                                </div>
                                <div style="overflow-x:auto;">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="natureContributions[]" id="natureContributions" multiple="multiple" data-height="100%">
                                            @foreach ($natureContributions as $item)
                                            <option value="{{$item->id}}" id="{{$item->id}}" selected>{{$item->libelle}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="card-footer text-right">
                                    <p style="cursor:pointer" class="btn btn-primary" onclick="addContributionParticipant(document.getElementById('nom_contribution_participant').value ,document.getElementById('montant_contribution_participant').value );">
                                        +</p>
                                </div>
                                <div style="overflow-x:auto;">
                        ...
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-footer text-right">
                                        <p style="cursor:pointer" class="btn btn-primary" onclick="addComiteScientifiqueNonLocal(document.getElementById('nom_comite_scientifique_non_local').value,document.getElementById('prenom_comite_scientifique_non_local').value ,document.getElementById('tel_comite_scientifique_non_local').value,document.getElementById('email_comite_scientifique_non_local').value,document.getElementById('type_entite_comite_scientifique_non_local').value ,document.getElementById('nom_entite_comite_scientifique_non_local').value,document.getElementById('pays_entite_comite_scientifique_non_local').value);">
                                            +</p>
                                    </div>
                                    <div style="overflow-x:auto;">
...
<script>
    ...
    function addContributeur(nom_contributeur, montant_contributeur, nature_contributeur, id_nature_contributeur, type_contributeur, type_contributeur_id) {
        ...
        if (type_contributeur != "" && nature_contributeur != "" && montant_contributeur != "" && nom_contributeur != "") {
            var contributeur = {
                nom: nom_contributeur,
                montant: montant_contributeur,
                nature_contribution_id: id_nature_contributeur,
                type_contributeur_id: type_contributeur_id
            }
            contributeurs[contributeurCount] = contributeur;
            contributeurCount = contributeurCount + 1
            var HtmlContent = " <tr><td>" + nom_contributeur + " </td> <td>" + montant_contributeur + " </td><td>" + type_contributeur + " </td><td>" + nature_contributeur + " </td><td> <button  class='btn btn-icon btn-danger' onClick='deleteContributeurRow(this);'><i class='fas fa-times'></i></button> </td></tr>"
