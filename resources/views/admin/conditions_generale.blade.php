        ...
        <div class="row">
            <div class="col-6">
                <div class="card-header">
                    <h4>Liste des conditions générales</h4>
                </div>
            </div>
...
<script>
    ...
    $("#create_form").fireModal({
        ...
        onFormSubmit: function(modal, e, form) {
            ...
            url = "{{route('conditions_generale.create')}}"
            $.ajax({
                url: url,
                cache: false,
                contentType: false,
    ...
    conditionsGenerale = @json($conditionsGenerale);
    for (var i = 0; i < conditionsGenerale.length; i < i++) {
        ...
        hideInput.value = conditionsGenerale[i].id
        ...
        $("#delete" + conditionsGenerale[i].id).fireModal({
            ...
            onFormSubmit: function(modal, e, form) {
                ...
                var url = '{{ route("conditions_generale.delete", ":id") }}';
        ...
        input.setAttribute("id", "libelle");
        input.setAttribute("name", "libelle");
        input.setAttribute("value", conditionsGenerale[i].libelle);
        input.setAttribute("required", true);
        input.classList.add('form-control')
        ...
        inputDescription.setAttribute("id", "description");
        inputDescription.setAttribute("name", "description");
        inputDescription.setAttribute("value", conditionsGenerale[i].description);
        inputDescription.setAttribute("required", true);
        inputDescription.classList.add('form-control')
        ...
        $("#update" + conditionsGenerale[i].id).fireModal({
            ...
            onFormSubmit: function(modal, e, form) {
                ...
                url = "{{route('conditions_generale.update')}}"
                $.ajax({
                    url: url,
                    cache: false,
                    contentType: false,
